      ...
      <el-main class="main">
        <el-row :gutter="20">
          <el-col :sm="12" :md="6" class="svg-icon svg-icon-1">
            <ListItem title="新访客数量" :amount="102097">
              <svg
          ...
          <el-col :sm="12" :md="6" class="svg-icon svg-icon-2">
            <ListItem title="消息数量" :amount="2097">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 128 128"
                id="icon-message"
          ...
          <el-col :sm="12" :md="6" class="svg-icon svg-icon-3">
            <ListItem title="金额" :amount="123218">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 128 128"
                id="icon-money"
          ...
          <el-col :sm="12" :md="6" class="svg-icon svg-icon-4">
            <ListItem title="商品数" :amount="323870">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 128 128"
                id="icon-shopping"
        ...
        <el-row class="chart-radar" :gutter="16">
          <el-col :span="8" :sm="24" :md="8">
            <Chart :config="basicRaderConfig"></Chart>
          </el-col>

          <el-col :span="8" :sm="24" :md="8">
            <Chart :config="customizedPieConfig"></Chart>
          </el-col>
