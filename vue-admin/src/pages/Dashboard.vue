  ...
  <el-container style="height: 100%; width: 100%; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu>
        ...
        <el-menu-item index="2">
          <i class="el-icon-message"></i>文档
        </el-menu-item>
        <el-menu-item index="3">
          <i class="el-icon-message"></i>引导页
        </el-menu-item>
        <el-submenu index="4">
          <template slot="title">
            <i class="el-icon-message"></i>权限测试页
          </template>
        ...
        <el-submenu index="8">
          <template slot="title">
            <i class="el-icon-message"></i>路由嵌套
          </template>
        ...
        <el-submenu index="10">
          <template slot="title">
            <i class="el-icon-message"></i>综合实例
          </template>
          <el-menu-item index="10-1">创建文章</el-menu-item>
          <el-menu-item index="10-2">文章列表</el-menu-item>
        </el-submenu>
        <el-menu-item index="11">
          <i class="el-icon-message"></i>Tab
        </el-menu-item>
        <el-submenu index="12">
          <template slot="title">
            <i class="el-icon-message"></i>错误页面
          </template>
    ...
    <el-container>
      ...
      <el-main class="main">
        <el-row :gutter="20">
          ...
          <el-col :sm="12" :md="6" class="svg-icon svg-icon-3">
            <div>
              ...
              >
                <path
                  d="M54.122 127.892v-28.68H7.513V87.274h46.609v-12.4H7.513v-12.86h38.003L.099 0h22.6l32.556 45.07c3.617 5.144 6.44 9.611 8.487 13.385 1.788-3.05 4.89-7.779 9.301-14.186L103.93 0h24.01L82.385 62.013h38.34v12.862h-46.41v12.4h46.41v11.937h-46.41v28.68H54.123z"
                />
              </svg>
              <div>
                <p class="svg-icon-title">Message</p>
        ...
        <el-row class="chart-radar" :gutter="16">
          <el-col :span="8" :sm="24" :md="8">
            <div ref="basicRadar" class="chart"></div>
          </el-col>

          <el-col :span="8" :sm="24" :md="8">
            <div ref="customizedPie" class="chart"></div>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    drawLine() {
      this.renderChart(this.$refs['lineChart'], {
        xAxis: {
          type: 'category',
    ...
    drawBasicRader() {
      this.renderChart(this.$refs['basicRadar'], {
        title: {
          text: '基础雷达图'
        },
        tooltip: {},
    ...
    drawCustomizedPie() {
      this.renderChart(this.$refs['customizedPie'], {
        backgroundColor: '#fff',
    ...
    drawBar() {
      this.renderChart(this.$refs['bar'], {
        xAxis: {
          type: 'category',
...
.svg-icon-1:hover svg path,
.svg-icon-2:hover svg path,
.svg-icon-3:hover svg path,
.svg-icon-4:hover svg path {
  fill: #fff;
}
.svg-icon-title {
  line-height: 18px;
